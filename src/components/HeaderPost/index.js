    ...
    return ( 
        <header className='absolute inset-x-0 top-0 z-50'>
            ...
            <div className='hidden lg:flex lg:gap-x-12'>
                ...
                <Link to='#contatoPost' className='text-base font-semibold leading-6 text-gray-900'>Contatos</Link>
            </div>
        ...
        <div className={`lg:hidden ${isSidebarOpen ? '' : 'hidden'}`} role='dialog' aria-modal='true'>
            ...
            <div className='fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10'>
                ...
                <div className='-my-6 divide-y divide-gray-500/10'>
                    ...
                    <Link to='#contatoPost' className='-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50'><button onClick={() => setIsSidebarOpen(false)}>Contatos</button></Link>
                    </div>
                    <div className='py-6'>
