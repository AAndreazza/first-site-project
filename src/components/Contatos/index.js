        ...
        <div class="bg-teal-700 py-8">
            ...
            <div>
                ...
                <div className='flex items-center ml-auto mr-20'>
                    <Link to='#' className='rounded-md bg-teal-500 px-4 py-2 text-2xl font-semibold text-white shadow-sm hover:bg-teal-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-500'>ENTRAR EM CONTATO</Link>
                </div>
            </div>
        </div>
